...
pub use options::{
    ...
    SIDEBAR_COLOR_ALL, SIDEBAR_COLOR_BORDER,
    SIDEBAR_COLOR_BRANCH, SIDEBAR_COLOR_COMMIT_HASH, SIDEBAR_COLOR_DIFF_ADDED,
    SIDEBAR_COLOR_DIFF_DELETED, SIDEBAR_COLOR_ERROR, SIDEBAR_COLOR_FILE_CHANGE,
    SIDEBAR_COLOR_FILTER_INACTIVE, SIDEBAR_COLOR_IDLE, SIDEBAR_COLOR_PET_BODY,
    SIDEBAR_COLOR_PET_EYE, SIDEBAR_COLOR_PORT, SIDEBAR_COLOR_PR_LINK, SIDEBAR_COLOR_RESPONSE_ARROW,
    SIDEBAR_COLOR_RUNNING, SIDEBAR_COLOR_SECTION_TITLE, SIDEBAR_COLOR_SELECTION,
    SIDEBAR_COLOR_SESSION, SIDEBAR_COLOR_SUBAGENT, SIDEBAR_COLOR_TASK_PROGRESS,
    SIDEBAR_COLOR_TEXT_ACTIVE, SIDEBAR_COLOR_TEXT_INACTIVE, SIDEBAR_COLOR_TEXT_MUTED,
    SIDEBAR_COLOR_WAIT_REASON, SIDEBAR_COLOR_WAITING, SIDEBAR_CURSOR, SIDEBAR_FILTER,
    ...
    SIDEBAR_NOTIFICATIONS_EVENTS, SIDEBAR_PET, SIDEBAR_PID, SIDEBAR_REPO_FILTER, SIDEBAR_WIDTH,
...
pub use types::{
    AgentType, CLAUDE_AGENT, CODEX_AGENT, OPENCODE_AGENT, PI_AGENT, SMELT_AGENT, PaneInfo,
    PaneStatus, PermissionMode, SessionInfo, WindowInfo, WorktreeMetadata,
};
