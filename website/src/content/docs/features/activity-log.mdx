...
The bottom panel's **Activity** tab shows tool-call history for the selected agent pane, written by the agent hook or local bridge.
...
| Pi          | Every built-in tool execution start the extension bridge emits |
